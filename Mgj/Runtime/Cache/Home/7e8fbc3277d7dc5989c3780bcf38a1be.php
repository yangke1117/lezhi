...
<div class="xd-page" data-reactid=".2">
		<div class="xd-header" data-reactid=".2.0">
			<h2 class="xd-title" data-reactid=".2.0.0">商品评论列表</h2>
					...
					<table class="xd-table">
						<thead>
							<tr>
								...
								<th class="name">评论IP</th>
								<th class="name">评论时间</th>
						...
						<tbody class="ass">
						<?php if(is_array($com)): foreach($com as $key=>$vo): ?><tr id="add">
								<td>
								...
								<td>
									<div class="cat-name" style="width:60px;">
										<div class="cat-edit">
											<div class="xd-form-group " >
												<div class="xd-field">
													<?php echo ($vo['cip']); ?>
								...
								<td>
									<div class="cat-name" style="width:150px;">
										<div class="cat-edit">
											<div class="xd-form-group " >
												<div class="xd-field">
													<?php echo ($vo['content']); ?>
								...
								<td>
									<a href="<?php echo U('Home/Sort/comdel',array('id'=>$vo[id]));?>" class="btn btn-xs btn-danger" onclick="if(!confirm('确定要删除吗，你确认要删除吗？')){return false;}">
