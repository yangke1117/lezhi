...
<body class=" pace-done" style="background:#e7e8eb">
	...
	<div class="xd-page" data-reactid=".2">
		<div class="xd-header" data-reactid=".2.0">
			<h2 class="xd-title" data-reactid=".2.0.0">商品审核未通过</h2>
			<div class="xd-section">
				<div class="xd-section-body">
					<table class="xd-table">
						...
						<tbody class="ass">
						<?php if(is_array($au)): foreach($au as $key=>$vo): ?><tr id="add">
								<td>
									<span class="rank"><?php echo ($vo['id']); ?></span>
								</td>
								<td>
									<div class="cat-name">
										<div class="cat-edit">
								...
								<td>
									<div class="cat-name">
										<div class="cat-edit">
											<div class="xd-form-group " >
												<div class="xd-field">
													<img src="<?php echo ($vo["goodpic"]); ?>" alt="" width="40">
												</div>
											</div>
										</div>
									</div>
								...
								<td>
									<a href="<?php echo U('Home/Sort/set',array('id'=>$vo[id]));?>" title="设置详细信息" class="btn btn-xs btn-success">
										<i class="icon-ok bigger-120"></i>
									</a>
									<a href="<?php echo U('Home/Sort/argument',array('id'=>$vo[id]));?>" title="设置商品参数">
										<img src="/Public/Admin/images/canshu.png" alt="" width="32.4063" height="26">
									</a>
									<a href="<?php echo U('Home/Sort/goodedit',array('id'=>$vo[id]));?>" title="修改商品状态" class="btn btn-xs btn-info">
										<i class="icon-edit bigger-120"></i>
									</a>

									<a href="<?php echo U('Home/Sort/delete',array('id'=>$vo[id]));?>" class="btn btn-xs btn-danger" onclick="if(!confirm('确定要删除吗，你确认要删除吗？')){return false;}">
										<i class="icon-trash bigger-120"></i>
									</a>
									
									<a href="<?php echo U('Home/Sort/detail',array('id'=>$vo['id']));?>" title="图片上传" class="btn btn-xs btn-warning">
