...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="/lezhi/Public/Home/css/login.css">
            ...
            <div class="dl_fk">
                ...
                <div class="dl_logocon">
                    ...
                    <div class="dl_lg_form">
                        <form action="/lezhi/index.php/Home/User/login" method="post">
                        ...
                        <div class="dl_lg_reg">
                            <span>海外手机登录</span><a href="/lezhi/index.php/Home/User/register">新用户注册</a>
                        </div>
                        <div class="dl_ot_login">
                            <span>你也可以用以下方式登录：</span>
                            <div class="dl_ot_btn">
                                <a href=""><img src="/lezhi/Public/Home/images/d_qq.png"></a>
                                <a href=""><img src="/lezhi/Public/Home/images/d_weixin.png"></a>
                                <a href=""><img src="/lezhi/Public/Home/images/d_xl.png"></a>
                                <a href=""><img src="/lezhi/Public/Home/images/d_weibo.png"></a>
                                <a href=""><img src="/lezhi/Public/Home/images/d_ren.png"></a>
                                <a href=""><img src="/lezhi/Public/Home/images/d_tong.png"></a>
                            </div>
                        </div>
                    </div>
                    </div>
