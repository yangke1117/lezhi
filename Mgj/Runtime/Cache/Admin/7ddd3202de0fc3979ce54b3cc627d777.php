    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <div class="nav-search" id="nav-search">
                <form class="form-search" action="<?php echo U('Admin/User/index');?>" method="get">
                    <span>
                        <label>
                                ...
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
                                    ...
                                    <tbody>
                                        <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                                            ...
                                            <td class="hidden-480"><img src="/lezhi/<?php echo ($v["userpic"]); ?>" width="30"></td>
                                            <td><?php echo ($v['tel']); ?></td>
                                            <td><?php echo ($v['email']); ?></td>
                                            <td><?php echo (date("Y-m-d H:i:s",$v['rtime'])); ?></td>
                                            <td><?php echo getStore($v['store']);?></td>
                                            <td><?php if($v['groupid'] == 0): ?>无<?php else: echo ($v['title']); endif; ?></td>
                                            <td>
                                                <div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">

                                                    <a href="/lezhi/index.php/Admin/User/edit/id/<?php echo ($v["userid"]); ?>.html" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120"></i>
                                                    </a>

                                                    <a href="/lezhi/index.php/Admin/User/delete/id/<?php echo ($v["userid"]); ?>.html" class="btn btn-xs btn-warning"/>
