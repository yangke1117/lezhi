    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <div class="nav-search" id="nav-search" method="get">
                <form class="form-search" action="/lezhi/index.php/Admin/WebFirst/index" method="get">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/lezhi/index.php/Admin/WebFirst/del" method="post">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover"
                                        ...
                                        <tbody>
                                        <?php if(is_array($lunbo)): foreach($lunbo as $key=>$vo): ?><tr>
                                                <td><?php echo ($vo['id']); ?></td>
                                                <td>
                                                    <img src="<?php echo ($vo['lunbo']); ?>" alt="" style="width: 100px">
                                                </td>
                                                <td>
                                                    <div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                        <a href="<?php echo U('Admin/WebFirst/picDel',array('id'=>$vo['id']));?>"
