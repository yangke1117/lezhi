					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-responsive">
								<form action="/index.php/Admin/Config/update" method="post" enctype="multipart/form-data">
								<table id="sample-table-1" class="table table-striped table-bordered table-hover">
									<tbody>
										<tr>
											<td style="text-align:right;">头部LOGO：</td>
											<td><input type="file" name="headlogo" value="" style="float:left;"><img src="<?php echo ($data["headlogo"]); ?>" width="100"></td>
										</tr>
										<tr>
											<td style="text-align:right;">底部LOGO：</td>
											<td><input type="file" name="footlogo" value="" style="float:left;"><img src="<?php echo ($data["footlogo"]); ?>" width="100"></td>
										</tr>
										<tr>
											<td style="text-align:right;">网站标题：</td>
											<td><input type="text" name="title" style="width:70%;" value="<?php echo ($data["title"]); ?>"></td>
										</tr>
										<tr>
											<td style="text-align:right;">网站关键字：</td>
											<td><input type="text" style="width:70%;" name="keywords" value="<?php echo ($data["keywords"]); ?>"></td>
										</tr>
										<tr>
											<td style="text-align:right;">网站版权：</td>
											<td><input type="text" style="width:70%;" name="copyright" value="<?php echo ($data["copyright"]); ?>"></td>
										</tr>
										<tr>
											<td style="text-align:right;">网站版权描述：</td>
											<td><input type="text" style="width:70%;" name="content" value="<?php echo ($data["content"]); ?>"></td>
										</tr>
										<tr>
											<td style="text-align:right;">描述：</td>
											<td><input type="text" style="width:70%;" name="description" value="<?php echo ($data["description"]); ?>"></td>
										</tr>
										<tr>
											<td style="text-align:right;">注册号：</td>
											<td><input type="text" style="width:70%;" name="registerid" value="<?php echo ($data["registerid"]); ?>"></td>
										</tr>
										<tr>
											<td style="text-align:right;">许可证：</td>
											<td><input type="text" style="width:70%;" name="allow" value="<?php echo ($data["allow"]); ?>"></td>
										</tr>
										<tr>
											<td style="text-align:right;">备案号</td>
											<td><input type="text" style="width:70%;" name="number" value="<?php echo ($data["number"]); ?>"></td>
										</tr>
										<tr>
											<td colspan="2" style="padding-left:220px;"><input class="btn no-border" type="submit" name="sub" value="修改网站信息"></td>
										</tr>
									</tbody>
								</table>
