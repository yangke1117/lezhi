	...
	<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<div class="nav-search" id="nav-search">
							<form class="form-search" action="/lezhi/index.php/Admin/Trash/shop" method="get">
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="table-responsive">
											<form action="/lezhi/index.php/Admin/Trash/index" method="post">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
												<thead>
													<tr>
														...
														<th class="center" class="hidden-480">商铺品牌</th>
												...
												<tbody>
													<?php if(is_array($shops)): foreach($shops as $key=>$shop): ?><tr>
														...
														<td class="hidden-480"><?php echo ($shop["brand"]); ?></td>
														<td class="hidden-480"><img src="/lezhi<?php echo ($shop["shoplogo"]); ?>" width="70"></td>
														<td>
															<div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																<a href="<?php echo U('Admin/Trash/shopdelete',array('id'=>$shop['shopid']));?>" class="btn btn-xs btn-danger">
