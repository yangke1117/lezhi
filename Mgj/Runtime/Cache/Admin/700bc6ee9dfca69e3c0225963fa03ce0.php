    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <div class="nav-search" id="nav-search">
                <form class="form-search" action="/index.php/Admin/Order/index" method="get">
                                ...
                                <div class="col-xs-12">
                                    <div class="table-responsive">
                                            <table style="text-align:center;" class="table table-striped table-bordered table-hover" id="sample-table-1">
                                                ...
                                                <?php if(is_array($orders)): foreach($orders as $key=>$vo): ?><tr>
                                                        ...
                                                        <td>
                                                            <div class="center">
                                                                ...
                                                                <a class="btn btn-xs btn-info" href="<?php echo U('Admin/Order/orderDetails', array('id'=>$vo['id']));?>">
                                                                    详细
                                                                </a>
                                                ...
                                                <tr>
                                                    <td colspan="13"><ul id="pages" class="pagination"><?php echo ($page); ?></ul></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                            <input type="submit" value="全部删除" name="sub">
