			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form class="form-horizontal" role="form" action="<?php echo U('Admin/Sort/update');?>" method="post" enctype="multipart/form-data">
							<!-- 一级分类样式 start-->
							<input type="hidden" name="asortid" value="<?php echo ($info['asortid']); ?>">
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 分类名称 </label>

								<div class="col-sm-9">
									<input type="text" style="width:200px" name="aname" value="<?php echo ($info['aname']); ?>" id="form-field-1" placeholder="请输入商品分类名称" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select name="parent">
										...
										<?php if(is_array($Sorts)): foreach($Sorts as $key=>$vo): ?><option value="<?php echo ($vo['asortid']); ?>"  <?php if($info['parent'] == $vo['asortid']): ?>selected<?php endif; ?>><?php echo ($vo['aname']); ?></option><?php endforeach; endif; ?>
									</select> 
								</div>
							</div>
