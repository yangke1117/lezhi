					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-responsive">
								<form action="<?php echo U('Admin/Goods/update');?>" method="post" enctype="multipart/form-data">
								<table id="sample-table-1" class="table table-striped table-bordered table-hover">
									<tbody>
											<input type="hidden" name="id" value="<?php echo ($info['id']); ?>">
										<tr>
											<td style="text-align:right;">商品名：</td>
											<td><input type="text" name="goodname" value="<?php echo ($info['goodname']); ?>"></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" name="nowprice" value="<?php echo ($info['nowprice']); ?>"></td>
										</tr>
										<tr>
											<td style="text-align:right;">库存：</td>
											<td><input type="text" name="stock" value="<?php echo ($info['stock']); ?>"></td>
										</tr>
										
										<tr>
											<td style="text-align:right;">图片：</td>
											<td><input type="file" name="goodpic" style="float:left;padding-top:23px;"><img src="<?php echo ($info['goodpic']); ?>" width="70"></td>
										</tr>
										<tr>
											<td style="text-align:right;">审核：</td>
											<td>
												<select name="audit">
													<option value="0" <?php if($info['audit'] == 0): ?>selected<?php endif; ?>>审核中</option>
													<option value="1" <?php if($info['audit'] == 1): ?>selected<?php endif; ?>>审核已通过</option>
													<option value="2" <?php if($info['audit'] == 2): ?>selected<?php endif; ?>>审核失败</option>
												</select>
											</td>
										</tr>
										<tr>
											...
											<td>
												<textarea name="describe" cols="30" rows="5"><?php echo ($info['describe']); ?></textarea>
											</td>
										</tr>
										<tr>
											<td colspan="5" style="padding-left:220px;"><input class="btn no-border" type="submit"value="修改商品"></td>
										</tr>
									</tbody>
								</table>
								</form>
