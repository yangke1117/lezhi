					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-responsive">
								<form action="/lezhi/index.php/Admin/Friend/del" method="post">
								<table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
									<thead>
										<tr>
											<th class="center">友情链接LOGO</th>
											<th class="center">友情链接名称</th>
											<th class="center" class="hidden-480">友情链接地址</th>
											<th class="center" class="hidden-480">友情链接描述</th>
											<th class="center" class="hidden-480">友情链接排序</th>
											<th class="center" class="hidden-480">操作</th>
										</tr>
									</thead>
									<tbody>
										<?php if(is_array($data)): foreach($data as $key=>$friend): ?><tr>
											<td><img src="/lezhi<?php echo ($friend["linklogo"]); ?>" width="30"></td>
											<td><?php echo ($friend["linkname"]); ?></td>
											<td><?php echo ($friend["url"]); ?></td>
											<td><?php echo ($friend["content"]); ?></td>
											<td><?php echo ($friend["ordernum"]); ?></td>
											<td>
												<div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">

													<a href="/lezhi/index.php/Admin/Friend/edit/id/<?php echo ($friend["id"]); ?>.html" class="btn btn-xs btn-info">
														<i class="icon-edit bigger-120">修改</i>
													</a>
													<a href="/lezhi/index.php/Admin/Friend/delete/id/<?php echo ($friend["id"]); ?>.html" class="btn btn-xs btn-info">
