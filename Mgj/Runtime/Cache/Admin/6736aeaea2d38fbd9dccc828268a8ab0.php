	...
	<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<div class="nav-search" id="nav-search">
							<form class="form-search" action="/index.php/Admin/Shop/index" method="get">
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="table-responsive">
											<form action="/index.php/Admin/Shop/index" method="post">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
												<thead>
													<tr>
														...
														<th class="center" class="hidden-480">商铺title</th>
														<th class="center" class="hidden-480">商铺关键字</th>
														<th class="center" class="hidden-480">商铺描述</th>
														<th class="center" class="hidden-480">商铺所在地区</th>
														<th class="center" class="hidden-480">商铺logo</th>
														<th class="center" class="hidden-480">操作</th>
													</tr>
												</thead>
												<tbody>
													<?php if(is_array($shops)): foreach($shops as $key=>$shop): ?><tr>
														<td><?php echo ($shop["shopid"]); ?></td>
														<td style="width:100px"><?php echo ($shop["shopname"]); ?></td>
														<td style="width:200px"><?php echo ($shop["title"]); ?></td>
														<td style="width:200px"><?php echo ($shop["keywords"]); ?></td>
														<td style="width:200px"><?php echo ($shop["description"]); ?></td>
														<td><?php echo ($shop["area"]); ?></td>
														<td class="hidden-480"><img src="<?php echo ($shop["shoplogo"]); ?>" width="70"></td>
														<td>
															<div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">

																<a href="<?php echo U('Admin/Shop/mod',array('id'=>$shop['shopid']));?>" class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a href="<?php echo U('Admin/Shop/delete',array('id'=>$shop['shopid']));?>" class="btn btn-xs btn-danger">
