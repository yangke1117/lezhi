...
<html lang="en">
 ...
 $AUTH = new \Think\Auth(); if($AUTH->check('Admin/Rule/index', session('admin.id'))){ ?>
    ...
    <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/lezhi/index.php/Admin/User/update" method="post" enctype="multipart/form-data">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="email" id="form-field-1" placeholder="格式符合的邮箱" class="col-xs-10 col-sm-5" value="<?php echo ($info["email"]); ?>"/><span class="esp"></span></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;">电话：</td>
                                            <td><input type="text" name="tel" id="form-field-1" class="col-xs-10 col-sm-5" value="<?php echo ($info["tel"]); ?>"/><span class="stel"></span></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;">头像</td>
                                            <td><input type="file" name="userpic" value=""><img src="/lezhi/<?php echo ($info["userpic"]); ?>" id="form-field-1" style="width:200px;" class="col-xs-10 col-sm-5" /></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;">个人简介</td>
                                            <td><textarea class="form-control" rows="3" name="resume" value="" id="form-field-1" placeholder="用户名" class="col-xs-10 col-sm-5" /><?php echo ($info['resume']); ?></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                            <select name="store">
                                                <option value="0" <?php if($info["store"] == 0): ?>selected<?php endif; ?>>无</option>
                                                <option value="1" <?php if($info["store"] == 1): ?>selected<?php endif; ?>>申请店铺</option>
                                                <option value="2" <?php if($info["store"] == 2): ?>selected<?php endif; ?>>店铺通过审核</option>
                                            </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <select name="groupid">
                                            <?php if(is_array($data)): foreach($data as $key=>$v): ?><option value="<?php echo ($v['id']); ?>" <?php if($info["groupid"] == $v['id']): ?>selected<?php endif; ?>><?php echo ($v['title']); ?></option><?php endforeach; endif; ?>
                                            </select>
                                            </td>
                                        </tr>
                                        <tr>
        ...
        <script src="/lezhi/Public/Admin/js/jquery-1.8.3.min.js"></script>
        <script>
            //邮箱的聚焦事件
