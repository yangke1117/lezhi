...
<html lang="en">
 ...
 $AUTH = new \Think\Auth(); if($AUTH->check('Admin/Rule/index', session('admin.id'))){ ?>
	...
	<meta charset="utf-8">
	<link href="/Public/Admin/css/sort.css" rel="stylesheet">
			...
			<div class="page-content">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form class="form-horizontal" role="form" action="<?php echo U('Admin/Sort/insert');?>" method="post" enctype="multipart/form-data">
							<!-- 一级分类样式 start-->
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 分类名称: </label>

								<div class="col-sm-9">
									<input type="text" style="width:200px" name="aname" id="form-field-1" placeholder="请输入商品分类名称" class="col-xs-10 col-sm-5" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 父级分类名称: </label>

								<div class="col-sm-9">
									<select name="parent">
										<option value="0">-----请----选----择------</option>
										<?php if(is_array($Sorts)): foreach($Sorts as $key=>$vo): ?><option value="<?php echo ($vo['asortid']); ?>"><?php echo ($vo['aname']); ?></option><?php endforeach; endif; ?>
									</select>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 添加属性: </label>
								<div class="col-sm-9">
									<div class="btn-group" data-toggle="buttons">
									  	<?php if(is_array($asort)): foreach($asort as $key=>$vo): ?><label class="btn btn-default"> 
							...
							<div class="clearfix form-actions">
								<div class="col-md-offset-3 col-md-9">
									<button class="btn btn-info">
										...
										<input type="submit" value="Submit" style="border:none;background:none;color:#fff;">
									</button>
