					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-responsive">
								<form action="/lezhi/index.php/Admin/Config/del" method="post">
								<table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
									<thead>
										<tr>
											<th class="center">头部LOGO</th>
											<th class="center">网站标题</th>
											<th class="center" class="hidden-480">网站关键字</th>
											<th class="center" class="hidden-480">底部LOGO</th>
											<th class="center" class="hidden-480">网站开关</th>
											<th class="center" class="hidden-480">网站版权</th>
											<th class="center" class="hidden-480">网站版权描述</th>
											<th class="center" class="hidden-480">描述</th>
											<th class="center" class="hidden-480">注册号</th>
											<th class="center" class="hidden-480">许可证</th>
											<th class="center" class="hidden-480">备案号</th>
											<th class="center" class="hidden-480">操作</th>
										</tr>
									</thead>
									<tbody>
										<?php if(is_array($data)): foreach($data as $key=>$config): ?><tr>
											<td><img src="/lezhi<?php echo ($config["headlogo"]); ?>" width="100"></td>
											<td><?php echo ($config["title"]); ?></td>
											<td><?php echo ($config["keywords"]); ?></td>
											<td><img src="/lezhi<?php echo ($config["footlogo"]); ?>" width="100"></td>
											<td><?php echo getSwitch($config['switch']);?></td>
											<td><?php echo ($config["copyright"]); ?></td>
											<td><?php echo ($config["content"]); ?></td>
											<td><?php echo ($config["description"]); ?></td>
											<td><?php echo ($config["registerid"]); ?></td>
											<td><?php echo ($config["allow"]); ?></td>
											<td><?php echo ($config["number"]); ?></td>
											<td>
												<div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">

													<a href="/lezhi/index.php/Admin/Config/edit/id/<?php echo ($config["id"]); ?>.html" class="btn btn-xs btn-info">
