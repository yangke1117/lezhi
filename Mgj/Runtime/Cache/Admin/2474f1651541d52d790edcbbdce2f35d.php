    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <div class="nav-search" id="nav-search">
                <form class="form-search" action="/lezhi/index.php/Admin/Trash/user" method="get">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/lezhi/index.php/Admin/Trash/del" method="post">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover"
                                        ...
                                        <tr>
                                            ...
                                            <th class="center" class="hidden-480">性别</th>
                                        ...
                                        <tbody>
                                        <?php if(is_array($data)): foreach($data as $key=>$sort): ?><tr>
                                                <td><?php echo ($sort['userid']); ?></td>
                                                <td class="text-left"><?php echo ($sort['username']); ?></td>
                                                <td class="hidden-480"><img src="/lezhi<?php echo ($sort[userpic]); ?>" alt=""></td>
                                                <td><?php echo getSex($sort[sex]);?></td>
                                                <td><?php echo ($sort['email']); ?></td>
                                                <td><?php echo (date("Y-m-d H:i:s",$sort['rtime'])); ?></td>
                                                <td><?php echo ($sort['tel']); ?></td>
                                                <td>
                                                    <div class="center"
                                                         class="visible-md visible-lg hidden-sm hidden-xs btn-group">

                                                        <a href="<?php echo U('Admin/Trash/useredit',array('id'=>$sort['id']));?>"
