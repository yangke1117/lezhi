	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li class="active">商铺公告列表</li>
			</ul><!-- .breadcrumb -->

			<div class="nav-search" id="nav-search" method="get">
				<form class="form-search" action="<?php echo U('Admin/Notice/index');?>" method="get">
					<span class="input-icon">
						<select name="num" aria-controls="dataTables-example" class="form-control input-sm">
				            <option value="3" <?php if($num == 3): ?>selected<?php endif; ?>>3</option>
					...
					<span class="input-icon">
						<input type="text" placeholder="Search ..." name="keyword" class="nav-search-input" id="nav-search-input" autocomplete="off" value="<?php echo ($keyword); ?>"/>
								...
								<table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
									<thead>
										<tr>
											...
											<th class="center">商铺公告标题</th>
											<th class="center" class="hidden-480">商铺公告摘要</th>
											<th class="center" class="hidden-480">商铺公告内容</th>
											<th class="center" class="hidden-480">商铺公告日期</th>
											<th class="center" class="hidden-480">商铺公告发布者</th>
											<th class="center" class="hidden-480">商铺公告对象</th>
											<th class="center" class="hidden-480">操作</th>
										</tr>
									</thead>
									<tbody>
										<?php if(is_array($data)): foreach($data as $key=>$store): ?><tr>
											<td><?php echo ($store['id']); ?></td>
											<td style="width:100px;"><?php echo ($store['storetitle']); ?></td>
											<td style="width:100px;"><?php echo ($store['storedigest']); ?></td>
											<td style="width:500px;"><?php echo ($store['storecontent']); ?></td>
											<td style="width:100px;"><?php echo ($store['storetime']); ?></td>
											<td style="width:100px;"><?php echo ($store['storeauthor']); ?></td>
											<td style="width:150px;"><?php echo ($store['storename']); ?></td>
											<td>
												<div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">
													<a href="<?php echo U('Admin/Notice/edit',array('id'=>$store[id]));?>" title="修改" class="btn btn-xs btn-info">
														<i class="icon-edit bigger-120"></i>
													</a>

													<a href="<?php echo U('Admin/Notice/delete',array('id'=>$store[id]));?>" class="btn btn-xs btn-danger" onclick="if(!confirm('确定要删除吗，你确认要删除吗？')){return false;}">
