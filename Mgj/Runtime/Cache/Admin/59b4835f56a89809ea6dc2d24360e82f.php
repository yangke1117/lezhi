								...
								<div class="row">
									<div class="col-xs-12">
										<div class="table-responsive">
											<form action="<?php echo U('Admin/Shop/update');?>" method="post" enctype="multipart/form-data">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<tbody>
													<tr>
														<td style="text-align:right;">商铺名：</td>
														<td><input type="text" name="shopname" value="<?php echo ($shops['shopname']); ?>"></td>
													</tr>
													<tr>
														<td style="text-align:right;">商铺title：</td>
														<td><input type="text" name="title" value="<?php echo ($shops['title']); ?>"></td>
													</tr>
													<tr>
														<td style="text-align:right;">商铺关键字：</td>
														<td><input type="text" name="keywords" value="<?php echo ($shops['keywords']); ?>"></td>
													</tr>
													<tr>
														<td style="text-align:right;">商铺描述：</td>
														<td><input type="text" name="description" value="<?php echo ($shops['description']); ?>"></td>
													</tr>
													<tr>
														<td style="text-align:right;">商铺logo：</td>
														<td><input type="file" name="shoplogo" style="float:left;padding-top:23px;"><img src="<?php echo ($shops['shoplogo']); ?>" width="70"></td>
													</tr>
													<tr>
														...
														<td>
															...
															<?php if(is_array($color)): foreach($color as $key=>$vo): ?><option value="<?php echo ($vo['color']); ?>" <?php if($shops['shopcolor'] == $vo['color']): ?>selected<?php endif; ?> >-----<?php echo ($vo['name']); ?>-----</option><?php endforeach; endif; ?>
															</select>
														</td>
													</tr>
													<tr>
														<td colspan="2" style="padding-left:220px;"><input class="btn no-border" type="submit" name="sub" value="修改商铺"></td>
													</tr>
												</tbody>
											</table>
											<input type="hidden" name="shopid" value="<?php echo ($shops['shopid']); ?>">
											</form>
