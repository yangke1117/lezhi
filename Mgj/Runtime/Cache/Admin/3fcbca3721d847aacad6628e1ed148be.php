    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <div class="nav-search" id="nav-search" method="get">
                <form class="form-search" action="/index.php/Admin/WebFirst/fenQu" method="get">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/index.php/Admin/WebFirst/del" method="post">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover"
                                           style="text-align:center;">
                                        <thead>
                                        <tr>
                                            <th class="center col-xs-6">分区名称</th>
                                            <th class="center" class="hidden-480">操作</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php if(is_array($f)): foreach($f as $key=>$vo): ?><tr>
                                                <td><?php echo ($vo['name']); ?></td>
                                                <td>
                                                    <div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                        <a data-id="<?php echo ($vo['id']); ?>" href="javascript:;"
	   ...
	   <script>
    	$(function() {
    		...
    		$('.delete').click(function() {
				...
				var url = "<?php echo U('Admin/WebFirst/delFenQu');?>";
				
				$.get(url, {id: id}, function(msg) {
					
					if (msg == 1) {
						that.parents().find('tr').remove();
