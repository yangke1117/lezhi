                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/lezhi/index.php/Admin/Rule/insert" method="post" enctype="multipart/form-data">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    <tbody>
                                        <tr>
                                            <td style="text-align:right;">规则名：</td>
                                            <td><input type="text" name="title" id="form-field-1" placeholder="规则名" class="col-xs-10 col-sm-5" /></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:right;">规  则：</td>
                                            <td><input type="text" name="name" id="form-field-1" placeholder="规则 (控制器名/方法名)" class="col-xs-10 col-sm-5" /></td>
                                        </tr>
                                        <tr>
