					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-responsive">
								<form action="/index.php/Admin/Comment/del" method="post">
								<table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
									<thead>
										<tr>
											...
											<th class="center" class="hidden-480">用户ID</th>
											<th class="center" class="hidden-480">评论IP</th>
											<th class="center" class="hidden-480">评论时间</th>
											<th class="center" class="hidden-480">评分</th>
											<th class="center" class="hidden-480">评论内容</th>
											<th class="center" class="hidden-480">操作</th>
										</tr>
									</thead>
									<tbody>
										<?php if(is_array($com)): foreach($com as $key=>$comment): ?><tr>
											<td><?php echo ($comment["id"]); ?></td>
											<td><?php echo ($comment["goodname"]); ?></td>
											<td><?php echo ($comment["userid"]); ?></td>
											<td><?php echo ($comment["cip"]); ?></td>
											<td><?php echo (date("Y-m-d H:i:s",$comment["ctime"])); ?></td>
											<td><?php echo ($comment["score"]); ?></td>
											<td><?php echo ($comment["content"]); ?></td>
											<td>
												<div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">

													<a href="<?php echo U('Admin/Comment/delete',array('id'=>$comment[id]));?>" class="btn btn-xs btn-danger" onclick="if(!confirm('确定要删除吗，你确认要删除吗？')){return false;}" class="btn btn-xs btn-danger">
										...
										<tr>
											<td colspan="8"><div class="row"><div class="col-md-5"></div><div id="pages"><?php echo ($pages); ?></div></td>
										</tr>
									</tbody>
								</table>
								</form>
