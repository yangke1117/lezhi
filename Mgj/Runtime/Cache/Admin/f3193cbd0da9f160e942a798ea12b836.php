	...
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<ul class="breadcrumb">
		 ...
		 <div class="nav-search" id="nav-search">
                <form class="form-search" action="<?php echo U('Admin/Group/index');?>" method="get">
                    <span>
                        <label>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="table-responsive">
							<form action="/lezhi/index.php/Admin/Group/delete" method="post">
							<table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
								<thead>
									<tr>
										...
										<!-- <th class="center" class="hidden-480">权限</th> -->
									...
									<?php if(is_array($res)): foreach($res as $key=>$v): ?><tr>
										...
										<td>
											<div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">
												...
												<a href="/lezhi/index.php/Admin/Group/edit/id/<?php echo ($v["id"]); ?>.html" class="btn btn-xs btn-info">
													<i class="icon-edit bigger-120"></i>
												</a>

												<a href="/lezhi/index.php/Admin/Group/delete/id/<?php echo ($v["id"]); ?>.html" class="btn btn-xs btn-danger">
							...
							<input type="submit" class="btn btn-primary btn-xs" name="sub" value="全部删除">
							</form>
